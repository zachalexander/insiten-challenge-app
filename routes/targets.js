                ...
                res.json({success: false, message: 'Company location is required.'});
                    ...
                    if(!req.body.keyContact1){
                      ...
                      if(!req.body.financialPerformance){
                        ...
                        if(!req.body.totalRevenue){
                          res.json({success: false, message: 'This must be a positive number without comma separators or symbols.' });
                        } else {
                          ...
                          if(!req.body.financialPerformance){
                            ...
                            if(!req.body.totalRevenue){
                              res.json({success: false, message: 'This must be a positive number without comma separators or symbols.' });
                                ...
                                target.totalRevenue = req.body.totalRevenue;
                                target.save((err) => {
                                  if (err) {
